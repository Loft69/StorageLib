...
public class CommandRegistry {
    ...
    protected void addSubCommand(@NonNull SubCommand... addedCommands) {
        for (SubCommand subCommand : addedCommands) subCommands.put(subCommand.getSubCommand().toLowerCase(), subCommand);
    }

    protected List<String> getSubArguments(){
        List<String> args = new ArrayList<>();
        for (SubCommand subCommand : subCommands.values()) args.add(subCommand.getSubCommand());
        return args;
    }
